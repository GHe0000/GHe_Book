...
\path (xljs.south) ++ (0,-2em) node[anchor=north] (xljsscalep){\highlight{red}{$\theta$为小量时，$\theta \approx \sin \theta \approx \tan \theta$(见\secref{s_xljs})}};
