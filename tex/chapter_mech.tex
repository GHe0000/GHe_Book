...
假定多星系统公共圆心不在质心处，则质心必定绕公共圆心做匀速圆周运动，那么根据之前的定理，系统总动量等于系统总质量乘上质心速度，故系统总动量方向将一直在变化。而该多星系统整体不受外力，因此系统总动量必须守恒，这与之前假设不符，故先前假设不成立，QED\footnote{QED为拉丁文quod erat demonstrandum的缩写，意为“证毕”}。
