...
\path (vci.east) ++ (2em,0) node[anchor=west, align=left] (scalep2){\highlight{blue}{根据定理\eqref{zxxxtdl}， \\ 此项恒等于$0$}};
\draw [color=blue!87](vci.east) -| ([xshift=0.3ex,color=blue]scalep2.west);
