...
设在地面系中，有两个物体$A$和$B$，质量分别为$m_A$、$m_B$，开始时两物体粘连在一起，以速度$v_0$共同运动。在某一时刻时，$A$、$B$之间的炸药爆炸，将$A$、$B$炸分离。炸药释放的能量为$\Delta E$。设分离后物体$A$、$B$的速度为$v_A$、$v_B$，则由动量守恒和能量守恒分别有：

$$m_A v_A + m_B v_B = (m_A + m_B) v_0 \quad \frac{1}{2} m_A v_A^2 + \frac{1}{2} m_B v_B^2 = \frac{1}{2} (m_A + m_B) v_0^2 + \Delta E$$